US09
Feature: Creación de contratos intuitiva por parte del emprendimiento

    Como emprendimiento, quiero que PromoTrust me facilite la realización de contratos dentro de la app.
