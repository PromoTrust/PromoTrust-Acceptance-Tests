US11
Feature: Seguimiento de Rendimiento en Tiempo Real del acuerdo publicitario como emprendimiento

    Como usuario emprendimiento, quiero que PromoTrust me permita realizar un seguimiento en tiempo 
...
campañas en las que esté trabajando en base al <influencer>
