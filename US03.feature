US03
Feature: Edición de perfil del emprendimiento

    Como usuario emprendimiento quiero poder editar mi perfil en base a mi estrategia y preferencias.
...
Example: Input
    ...
    |el usuario da clic al ícono <menu principal>|
