US08
Feature: Tips semanales y chat bot para consultas e información relevante del influencer

    Como usuario influenecer, quiero que PromoTrust me brinde información útil o tips con respecto al 
    proceso de colaboración y pueda ayudarme a resolver o aclarar dudas.
