US06
Feature: Búsqueda y Contacto con usuarios como influencer

    Como usuario influencer de la aplicación, quiero utilizar PromoTrust para buscar 
    emprendimientos favoritos o necesarios y ponerme en contacto con ellos de manera eficiente.
...
Scenario: Comunicación con emprendimientos en PromoTrust
